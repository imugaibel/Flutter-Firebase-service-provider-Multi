...
class allhiddenstart extends StatefulWidget {
  @override
  _allhiddenstartState createState() => _allhiddenstartState();
}

class _allhiddenstartState extends State<allhiddenstart> {
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Visibility(
                visible: status == Status.Rejected,
                child: Row(
                  children: [
                    InkWell(
                      onTap: () {
