...
import 'package:omni/model/chat-model.dart';
import 'package:omni/model/order-model.dart';
...
class Chat extends StatelessWidget {
  ...
  Chat({Key key, this.order}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(AppLocalization.of(context).translate("Chat")),
        centerTitle: true,
      ),
          ...
          return Container(
            child: Wrap(
              children: <Widget>[
                ...
                //   ),
                //   title: Text(
                //     AppLocalization.of(context).translate('Pdf file'),
                //     style: TextStyle(color: Theme.of(context).primaryColor),
                //   ),
                //   onTap: () =>
                //       _selectImage(context, imageSource: ImageSource.gallery),
